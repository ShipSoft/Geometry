...
GeoPhysVol* CalorimeterFactory::build() {
    ...
    if (stackZ > 2.0 * s_containerHalfZ)
        throw std::runtime_error("CalorimeterFactory: calo.cfg total stack Z (" +
    ...
    if (maxHalfX > s_containerHalfX)
        throw std::runtime_error("CalorimeterFactory: calo.cfg module array half-X (" +
    ...
    if (maxHalfY > s_containerHalfY)
        throw std::runtime_error("CalorimeterFactory: calo.cfg module array half-Y (" +
